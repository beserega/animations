window.onload = function () {
   ...
   if (animItems.length > 0) {
      // если таккие элементы на странице найдены
      console.log(
         `Ура!!! На нашей странице будет анимация! Найдено элементов для анимации - ${animItems.length}`,
      );
   ...
   const about = document.querySelector('#screen-two');
   if (button) {
